...
<p><font color=green>Q</font>:这个在线裁判系统使用什么样的编译器和编译选项?<br>
  <font color=red>A</font>:系统运行于<a href="http://www.debian.org/">Debian</a>
	Linux。<br>硬件环境为RaspberryPi3B+，CPU为armhf(硬浮点)架构，也就是说如果你用__asm，#pragma target之类的就要GG了。<br>使用<a href="http://gcc.gnu.org/">GNU GCC/G++</a> 作为C/C++编译器。
...
<p>  编译器版本为（系统可能升级编译器版本，这里仅供参考）:<br>
  <font color=blue>g++ (Raspbian 6.3.0-18+rpi1+deb9u1) 6.3.0 20170516</font><br>
</font></p>
<hr>
